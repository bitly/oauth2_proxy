...
func main() {
	...
	flagSet.String("basic-auth-accept", "", "force use of HTTP Basic Auth for specific accept header")
	flagSet.String("basic-auth-user-agent", "", "force use of HTTP Basic Auth for specific user agent")
