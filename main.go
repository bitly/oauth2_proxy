...
func main() {
	...
	flagSet.String("google-script-id", "", "Google App Script id that returns user groups")
	flagSet.String("google-script-function-name", "", "Google App Script function name that returns user groups")
