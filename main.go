...
var (
	...
	passSecret              = flag.String("pass-secret", "", "pass in X-Secret header to upstream (vulnerable to MITM)")
	rewriteHost             = flag.Bool("rewrite-host", false, "rewrite Host header in proxied requests to match upstream")
